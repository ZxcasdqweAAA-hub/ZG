package com.study.zhiguang.knowpost.listener;
...
public class FeedCacheInvalidationListener {
    ...
    private final com.study.zhiguang.counter.service.UserCounterService userCounterService;
    private final com.study.zhiguang.knowpost.mapper.KnowPostMapper knowPostMapper;
    public FeedCacheInvalidationListener(@Qualifier("feedPublicCache") Cache<String, FeedPageResponse> feedPublicCache,
                                         StringRedisTemplate redis,
                                         ObjectMapper objectMapper,
                                         com.study.zhiguang.counter.service.UserCounterService userCounterService,
                                         com.study.zhiguang.knowpost.mapper.KnowPostMapper knowPostMapper) {
